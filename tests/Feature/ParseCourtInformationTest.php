...
class ParseCourtInformationTest extends TestCase
{
    /**
     * @dataProvider courtHtmlProvider
     */
    public function test_parse_court_information_from_html($html, $name, $okrug, $region, $code, $phone, $email, $url)
    {
        ...
        $this->assertEquals($okrug, $data['okrug']);
